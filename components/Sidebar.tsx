            ...
            <Link
              ...
              className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                isActive
                  ...
                  : 'text-gray-500 dark:text-zinc-500 hover:bg-cream-100 dark:hover:bg-zinc-900 hover:text-gray-700 dark:hover:text-zinc-100 font-medium'
              }`}
            >
      ...
      <div className="px-4 py-4 border-t border-cream-200 dark:border-zinc-800/60">
        <div className="flex items-center justify-between mb-3 gap-3">
          ...
          <button
            ...
            className="h-8 px-3 rounded-lg border border-cream-200 bg-cream-100 text-[11px] font-semibold text-gray-600 hover:bg-cream-200 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-colors"
          >
